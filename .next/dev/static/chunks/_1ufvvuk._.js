...
;
var P = Object.create(null), g = (e)=>globalThis.process?.env || globalThis.Deno?.env.toObject() || globalThis.__env__ || (e ? P : globalThis), d = new Proxy(P, {
    get (e, t) {
        return g()[t] ?? P[t];
    },
    has (e, t) {
...
function j(e) {
    try {
        ...
        throw new S(`Invalid base URL: ${e}. Please provide a valid base URL.`);
    }
}
...
function x(e, t) {
    if (e) return R(e, t);
    let n = d.BETTER_AUTH_URL || d.NEXT_PUBLIC_BETTER_AUTH_URL || d.PUBLIC_BETTER_AUTH_URL || d.NUXT_PUBLIC_BETTER_AUTH_URL || d.NUXT_PUBLIC_AUTH_URL || (d.BASE_URL !== "/" ? d.BASE_URL : void 0);
    if (n) return R(n, t);
    if (typeof window < "u" && window.location) return R(window.location.origin, t);
}
;
;
var B = {
...
var w = (e, t, n, s)=>{
    ...
    for (let l of e)l.subscribe(()=>{
        c ? f() : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanostores$2f$lifecycle$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onMount"])(r, ()=>(f(), c = !0, ()=>{
                r.off(), l.off();
            }));
    });
    return r;
...
var C = (e)=>{
    let t = "credentials" in Request.prototype, n = x(e?.baseURL), s = e?.plugins?.flatMap((o)=>o.fetchPlugins).filter((o)=>o !== void 0) || [], r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$fetch$2f$fetch$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createFetch"])({
        baseURL: n,
        ...t ? {
            credentials: "include"
        } : {},
    ...
    }), { $sessionSignal: f, session: c } = F(r), l = e?.plugins || [], u = {}, a = {
        $sessionSignal: f,
        session: c
    }, i = {
        "/sign-out": "POST",
    ...
    }, p = [
        {
            ...
            matcher (o) {
                return o === "/sign-out" || o === "/update-user" || o.startsWith("/sign-in") || o.startsWith("/sign-up");
            }
        }
    ];
    for (let o of l)o.getAtoms && Object.assign(a, o.getAtoms?.(r)), o.pathMethods && Object.assign(i, o.pathMethods), o.atomListeners && p.push(...o.atomListeners);
    let m = {
        notify: (o)=>{
            a[o].set(!a[o].get());
        },
    ...
    for (let o of l)o.getActions && Object.assign(u, o.getActions?.(r, m));
    return {
        pluginsActions: u,
        pluginsAtoms: a,
        pluginPathMethods: i,
...
function V(e, t, n) {
    let s = t[e], { fetchOptions: r, query: f, ...c } = n || {};
    return s || (r?.method ? r.method : c && Object.keys(c).length > 0 ? "POST" : "GET");
}
    ...
    function f(c = []) {
        return new Proxy(function() {}, {
            get (l, u) {
                ...
                for (let p of a)if (i && typeof i == "object" && p in i) i = i[p];
                else {
                    i = void 0;
                    break;
                }
                return typeof i == "function" ? i : f(a);
            },
            apply: async (l, u, a)=>{
                let i = "/" + c.map((A)=>A.replace(/[A-Z]/g, (h)=>`-${h.toLowerCase()}`)).join("/"), p = a[0] || {}, m = a[1] || {}, { query: o, fetchOptions: O, ..._ } = p, y = {
                    ...m,
                    ...O
                }, U = V(i, n, p);
                return await t(i, {
...
function T(e, { keys: t, deps: n = [
    ...
    s.current = e.get();
    let r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((c)=>(t?.length || 0) > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nanostores$2f$listen$2d$keys$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listenKeys"])(e, t, E(s, c)) : e.listen(E(s, c)), n), f = ()=>s.current;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(r, f, f);
}
function Q(e) {
    return `use${X(e)}`;
}
...
function Ue(e) {
    let { pluginPathMethods: t, pluginsActions: n, pluginsAtoms: s, $fetch: r, $store: f, atomListeners: c } = C(e), l = {};
    for (let [i, p] of Object.entries(s))l[Q(i)] = ()=>T(p);
    let u = {
        ...n,
        ...l,
        $fetch: r,
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signIn"].email({
                email,
                password
            });
            if (res.error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex min-h-screen flex-col justify-center px-6 py-12",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "sm:mx-auto sm:w-full sm:max-w-sm",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-600 text-white shadow-md",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "เข้าสู่ระบบบริหารการเงินครอบครัว"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(auth)/login/page.tsx",
                        lineNumber: 49,
                        columnNumber: 9
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: isSubmitting ? 'กำลังตรวจสอบ...' : 'เข้าสู่ระบบ'
                            }, void 0, false, {
                                fileName: "[project]/src/app/(auth)/login/page.tsx",
                                lineNumber: 95,
                                columnNumber: 13
...
_s(LoginPage, "iT82ofxed6FNOevUEjPwLIRr7XI=", false, function() {
    return [
...
//# sourceMappingURL=_1ufvvuk._.js.map