...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signIn"].email({
                email,
                password
            });
            if (res.error) {
...
//# sourceMappingURL=src_1432nn8._.js.map